...
172 / 4 # = 43
44 + 43 # = 87
tic(); for(i in unique(ws_cty_int_lookup$batch)[44:86]){ # loop through 2nd of 4 meta-batches
  ...
  st_intersection(  i_layer                                 # selected blocks
    ...
    write_csv(  file = paste0(getwd(),
                              ...
                              '/input_data/walkshed_block_intersections/walkshed_block_intersections_batch_2_44_to_86.csv'
    )
    , append = TRUE
    , progress = TRUE)
