...
44 + 43     # = 87
44 + (43)*2 # = 130
tic(); for(i in unique(ws_cty_int_lookup$batch)[87:130]){ # loop through 3nd of 4 meta-batches
  ...
  st_intersection(  i_layer                                 # selected blocks
    ...
    write_csv(  file = paste0(getwd(),
                              ...
                              '/input_data/walkshed_block_intersections/walkshed_block_intersections_batch_3_87_to_130.csv'
    )
    , append = TRUE
    , progress = TRUE)
